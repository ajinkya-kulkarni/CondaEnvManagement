...
function create_environment 
{
	...
	pip install numpy==1.24.2 opencv-python-headless==4.7.0.72 imageio==2.26.0 scikit-image==0.19.3 scipy==1.10.1 matplotlib==3.7.0 tqdm==4.64.1 tifffile==2023.2.28 Pillow==9.4.0 streamlit==1.19.0 streamlit-image-comparison==0.0.3 notebook==6.5.2 ipywidgets==8.0.4
